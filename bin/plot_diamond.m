% Plot a diamond patch and axis labels
% Called by: plot_samples.m
% *************************************************************************
% M-File: plot_diamond.m
...
function [pax] = plot_diamond(linesetup,plotsel,header,scafac,labels,fonts,pax)
% Define the frame line
line = 1;
% Get the index from plotsel
[plotsel,~] = find(plotsel == 1);
% Enable overlay plotting
hold(pax,'on')
% Create a white background patch
patch('XData',[0 0.5 1 0.5 0],'YData',[0 -sin(1/3*pi) 0 sin(1/3*pi) 0],...
      'Parent',pax,'FaceColor',[1,1,1],'Visible','on');
% Plot the frame line
plot([0 0.5 1 0.5 0],[0 -sin(1/3*pi) 0 sin(1/3*pi) 0],'Parent',pax,...
...
text(0.50,0.90,subscript_labels(labels{plotsel,3}{2,1},header),...
                             'Parent',pax,...
                             ...
                             'FontUnits',fonts.FontUnits,...
                             'FontWeight',fonts.FontWeight);
text(0.50,-0.90,subscript_labels(labels{plotsel,3}{3,1},header),...
                             'Parent',pax,...
                             'HorizontalAlignment','center',...
                             'Color',fonts.Color,...
                             'FontName',fonts.FontName,...
                             ...
                             'FontUnits',fonts.FontUnits,...
                             'FontWeight',fonts.FontWeight);
text(-0.01,0,subscript_labels(labels{plotsel,3}{4,1},header),...
                             'Parent',pax,...
