% Plot a ternary patch and axis labels
% Called by: plot_samples.m
% *************************************************************************
% M-File: plot_ternary.m
...
function [pax] = plot_ternary(linesetup,plotsel,header,scafac,labels,fonts,pax)
...
text(0.50,0.89,subscript_labels(labels{plotsel,3}{2,1},header),...
                             'Parent',pax,...
