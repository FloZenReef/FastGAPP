function [plotax] = fastgapp_lineswitch(control,plotax,plotsel)
...
hold(plotax,'on')
  ...
  [plotax] = lines_condie_2005_ZrNbNbTh(control,plotax);
  %
  %
  ...
  [plotax] = lines_pearce_cann_1973_Sr2Ti100Zr(control,plotax);
  %
  %
  ...
  [plotax] = lines_pearce_cann_1973_Ti1003YZr(control,plotax);
  %
  %
  ...
  [plotax] = lines_wood_1980_ThHf3Ta(control,plotax);
  %
  %
  ...
  [plotax] = lines_cabanis_lecolle_1989_Nb8Y15La10(control,plotax);
  %
  %
  ...
  [plotax] = lines_hollocher_etal_2012_NbLaLaYb(control,plotax);
  %
  %
  ...
  [plotax] = lines_hollocher_etal_2012_TaLaLaYb(control,plotax);
  %
  %
  ...
  [plotax] = lines_hollocher_etal_2012_NbTaLaLaYb(control,plotax);
  %
  %
