function [plotax] = labels_eby_1992_RbNbYNb(control,plotax)

% Label segment #01
fontsel = 2;
text(0.400,4.000,sprintf('A1-type anorogenic granites\n(related to ocean island-type sources)'),'Rotation', 0,...
