function [plotax] = labels_miyashiro_1974_FeOMgOvsSiO2(control,plotax)

% Label segment #01
fontsel = 2;
text(57.500,3.500,sprintf('Arc tholeiitic'),'Rotation', 0,...
...
% Label segment #02
fontsel = 2;
text(65.000,2.200,sprintf('Arc calc-alkaline'),'Rotation', 0,...
        'Parent',plotax,'HorizontalAlignment','center','VerticalAlignment','middle',...
        'Color',control.setup.fonts(fontsel).Color,...
        'FontName',control.setup.fonts(fontsel).FontName,...
        'FontAngle',control.setup.fonts(fontsel).FontAngle,...
