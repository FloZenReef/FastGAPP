function [plotax] = labels_miyashiro_shido_1975_VvsFeOMgO(control,plotax)

% Label segment #01
fontsel = 2;
text(3.900,72.000,sprintf('Tholeiitic'),'Rotation', 0,...
...
% Label segment #02
fontsel = 2;
text(3.000,40.000,sprintf('Arc calc-alkaline'),'Rotation', 0,...
        'Parent',plotax,'HorizontalAlignment','center','VerticalAlignment','middle',...
        'Color',control.setup.fonts(fontsel).Color,...
        'FontName',control.setup.fonts(fontsel).FontName,...
        'FontAngle',control.setup.fonts(fontsel).FontAngle,...
