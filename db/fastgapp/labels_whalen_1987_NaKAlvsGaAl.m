function [plotax] = labels_whalen_1987_NaKAlvsGaAl(control,plotax)

% Label segment #01
fontsel = 2;
text(4.000,1.000,sprintf('A-type granites'),'Rotation', 0,...
...
% Label segment #02
fontsel = 2;
text(1.750,0.675,sprintf('Other granits\n(I, S, M)'),'Rotation', 0,...
        'Parent',plotax,'HorizontalAlignment','center','VerticalAlignment','middle',...
        'Color',control.setup.fonts(fontsel).Color,...
        'FontName',control.setup.fonts(fontsel).FontName,...
        'FontAngle',control.setup.fonts(fontsel).FontAngle,...
